<template>
<div class="flex flex-colitems-center justify-center align-middle">
    <div
        v-if="fetching"
            aria-label="Loading..."
            role="status"
            class="flex justify-center align-middle  h-[40vh] w-[20vw] "
        >
  ...
  <div class="mb-4 flex flex-col items-center">
    <Label class="self-start my-2" for="pin-input">{{ $t('twofa_code') }}</Label>
