...
<script>
import Emoji from '@/components/provided/Emoji/Emoji'
import FolderIcon from '@/components/provided/Icons/FolderIcon'
import { LinkIcon, MoreVerticalIcon, EyeIcon } from 'vue-feather-icons'
import FileIconThumbnail from '@/components/provided/Icons/FileIconThumbnail'
import MemberAvatar from '@/components/provided/Others/MemberAvatar'
