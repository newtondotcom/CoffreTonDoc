...
<script>
import FilePreviewDetail from '@/components/provided/Others/FilePreviewDetail'
import CopyShareLink from '@/components/provided/Inputs/CopyShareLink'
import {Edit2Icon, LockIcon, UnlockIcon, EyeOffIcon} from 'vue-feather-icons'
import ImageMetaData from '@/components/provided/UI/Others/ImageMetaData'
import TitlePreview from '@/components/provided/UI/Labels/TitlePreview'
import TeamMembersPreview from '@/components/provided/Teams/Components/TeamMembersPreview'
import ListInfoItem from '@/components/provided/UI/List/ListInfoItem'
