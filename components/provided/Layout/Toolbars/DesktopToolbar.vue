...
<script>
import TeamMembersButton from '@/components/provided/Teams/Components/TeamMembersButton'
import TeamFolderPreview from '@/components/provided/Teams/Components/TeamFolderPreview'
import PopoverWrapper from '@/components/provided/UI/Popover/PopoverWrapper'
import FileSortingOptions from '@/components/provided/Menus/FileSortingOptions'
import PopoverItem from '@/components/provided/UI/Popover/PopoverItem'
import UploadProgress from '@/components/provided/UI/Others/UploadProgress'
import NavigationBar from './NavigationBar'
import ToolbarButton from '@/components/provided/UI/Buttons/ToolbarButton'
