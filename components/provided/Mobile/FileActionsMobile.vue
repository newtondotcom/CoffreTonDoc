...
<script>
import MobileActionButton from '@/components/provided/UI/Buttons/MobileActionButton'
...
@import '@/components/sass/vuefilemanager/variables';
@import '@/components/sass/vuefilemanager/mixins';
