    ...
    <Dialog>
        ...
        <DialogContent v-if="stateDialog == 'newFile'" class="sm:max-w-[425px]">
            ...
            <DialogFooter>
                <DialogClose as-child>
                    <Button
                        @click="createNewFile(newFileName, newFileExtension)"
                    >
                        {{ $t('create') }}
                    </Button>
                </DialogClose>
        ...
        >
            ...
            <DialogFooter>
                <DialogClose as-child>
                    <Button
                        @click="createNewFolder(file, 'folder', newFolderName)"
                    >
                        {{ $t('create') }}
                    </Button>
                </DialogClose>
    ...
    if (fileLocal.value) {
        ...
        if (!assert(newFileExtension.value == props.file.extension)) {
            toast({
                title: 'Error',
                description:
                    'File extension is not the same as the original file',
                variant: 'destructive',
            });
        } else {
