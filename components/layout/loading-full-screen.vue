<template>
    ...
    >
        <div class="space-y-6 p-6">
            ...
            >
                <div
                    :class="{ 'text-primary': currentStep > UploadState.STEP1 }"
                    class="w-[160px]"
                >
                ...
                >
                    ...
                    >
                        <svg
                            class="h-6 w-6 animate-spin fill-primary"
                            viewBox="3 3 18 18"
                        >
                            <path
                                class="opacity-20"
            ...
            >
                <div
                    :class="{ 'text-primary': currentStep > UploadState.STEP2 }"
                    class="w-[160px]"
                >
            ...
            >
                <div
                    :class="{ 'text-primary': currentStep > UploadState.STEP3 }"
                    class="w-[160px]"
                >
                    Upload du fichier
                </div>
